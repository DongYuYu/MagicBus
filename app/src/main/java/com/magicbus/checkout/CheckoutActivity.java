...
//        fg.setAdapter(getIntent().getIntArrayExtra("adjustSeats"));
        ...
        arg.putIntArray("adjustSeats", getIntent().getIntArrayExtra("adjustSeats"));
        fg.setArguments(arg);

        getSupportFragmentManager().beginTransaction().replace(R.id.frag_container, fg)
                .addToBackStack(null)
                .commit();
    }
